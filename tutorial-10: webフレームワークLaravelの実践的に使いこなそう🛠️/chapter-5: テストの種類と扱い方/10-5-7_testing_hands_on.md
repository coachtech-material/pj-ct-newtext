...
| Step | やること | 説明 |
|:-----|:---------|:-----|
| 1 | テストクラスを作成する | `make:test`コマンドで生成 |
| 2 | RefreshDatabaseを設定する | テスト間の干渉を防ぐ |
| 3 | ユーザー作成テストを実装する | 正常系テスト |
| 4 | メールアドレス重複テストを実装する | 異常系テスト |
| 5 | テストを実行する | 全テストがパスすることを確認 |
