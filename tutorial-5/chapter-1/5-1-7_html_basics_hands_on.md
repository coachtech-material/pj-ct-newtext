...
#### ステップ1: 作業ディレクトリを作成し、HTMLファイルを作成する

まず、HTMLファイルを保存するためのディレクトリを作成します。ターミナルで以下のコマンドを実行してください。
...
ファイルを保存したら、ブラウザで`~/html-practice/self-introduction.html`を開いて、以下を確認します：
