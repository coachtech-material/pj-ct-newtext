...
*   シーダー（Seeder）を使った初期データ投入の仕組みを理解する。
*   開発環境でダミーデータを効率的に生成する方法を理解する。
*   シーダーとファクトリーの違いを理解する。
...
ユーザーと投稿のように、リレーションシップを持つデータを投入する場合は、以下のようになります。
...
このセクションでは、シーダーを使って初期データを投入する仕組みを学びました。
