...
次のセクションでは、Dockerとよく比較される「仮想マシン」との違いについて、詳しく見ていきましょう。

---

## 📝 学習のポイント

- [ ] Dockerが解決する、最も大きな問題は、「環境差異」の問題であることを説明できる。
- [ ] 「コンテナ」という概念を、「海外引越し用のコンテナ」などの比喩を使って、説明できる。
- [ ] Dockerを使うことで、チーム開発が、どのように効率化されるのかを説明できる。
