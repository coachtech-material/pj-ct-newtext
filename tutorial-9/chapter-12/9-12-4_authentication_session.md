...
- [ ] 認証の仕組みを理解している
- [ ] HTTPがステートレスであることを理解している
- [ ] セッションとCookieの役割と違いを説明できる
- [ ] Laravelのセッション管理機能を使える
- [ ] セッションハイジャック攻撃とその対策を理解している
- [ ] ログイン時にセッションIDを再生成する理由を説明できる
- [ ] HttpOnlyフラグ、Secureフラグ、SameSite属性の役割を理解している
- [ ] Remember Me機能の仕組みを理解している
