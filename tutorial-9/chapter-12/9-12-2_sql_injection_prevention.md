...
- [ ] SQLインジェクション攻撃の仕組みを理解している
- [ ] プリペアドステートメントがどのように攻撃を防ぐかを説明できる
- [ ] Eloquent ORMとクエリビルダーが自動的に保護することを理解している
- [ ] 生SQLを使う際は、プレースホルダーを使う必要があることを理解している
- [ ] ORDER BY句など、プレースホルダーが使えない場合の対策を知っている
- [ ] ホワイトリストとバリデーションの重要性を理解している
