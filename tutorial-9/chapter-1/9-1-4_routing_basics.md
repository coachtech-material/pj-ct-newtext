...
> **📌 このセクションの目的**
> 
> このセクションは、Laravelの中心概念である**MVCのイメージを膊らませる**ことが目的です。
> コードの書き方を覚えることよりも、「全体の流れ」を直感的に理解することを優先してください。
> 実際のコードの書き方は、次のセクション以降で詳しく学びます。

---

## 🏛️ Laravelは「MVC」という設計パターンを使っている

Laravelを学ぶ前に、まず知っておいてほしいことがあります。

Laravelは、**MVC（エム・ブイ・シー）**という設計パターンを採用しています。
...
でも、「Model」「View」「Controller」と言われても、いまいちピンと来ないですよね。
