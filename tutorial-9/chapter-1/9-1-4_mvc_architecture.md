...
- [ ] MVCアーキテクチャが、Model、View、Controllerの3つの役割に分ける設計思想であることを理解した。
- [ ] Model、View、Controllerがそれぞれどのような役割を持つか、自分の言葉で説明できる。
- [ ] Laravelにおけるデータの流れを、図を見ながら説明できる。
- [ ] MVCで役割を分けることのメリットを、3つ以上挙げることができる。
