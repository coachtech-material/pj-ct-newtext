...
- [ ] なぜテーブルを分割する必要があるのかを、データの「重複」と「不整合」という言葉を使って説明できる。
- [ ] 「主キー」と「外部キー」がそれぞれ何であるか、その役割を説明できる。
- [ ] 「1対多」の関係がどのようなものか、具体的な例（ユーザーと投稿など）を挙げて説明できる。
- [ ] 「多対多」や「1対1」の関係についても、簡単な例を説明できる。
