...
以下は、ユーザーと投稿の関係を表す、シンプルなER図の例です。
...
この図は、**Mermaid**という、テキストから図を生成するツールの記法で書かれています。GitHubや、多くの、Markdownエディタで、そのまま、表示できます。
...
1.  phpMyAdminでデータベース（例: `practice_db`）を選択します。
