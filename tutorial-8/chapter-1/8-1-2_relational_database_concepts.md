...
- [ ] 1枚の、巨大なテーブルが、抱える、2つの、主要な、問題点を、説明できる。
- [ ] 「データの、重複をなくし、更新を、容易にするため」に、テーブルを、分割する必要があることを、理解した。
- [ ] 分割された、テーブルが、共通の、IDによって、「関係」付けられていることを、説明できる。
- [ ] 「正規化」という、言葉の、基本的な、意味を、説明できる。
""
