...
- [ ] `DELETE` 文の、基本的な、構文を、理解し、特定の、レコードを、削除できる。
- [ ] `WHERE` 句の、重要性を、理解し、なぜ、省略しては、いけないのかを、説明できる。
- [ ] `DELETE` を、実行する前に、`SELECT` で、対象を、確認する、という、安全な、手順を、理解した。
- [ ] `DELETE` と `TRUNCATE TABLE` の、主な、違いを、説明できる。
- [ ] phpMyAdminの、GUIを、使って、データを、削除できる。
""
