...
- [ ] `INSERT` 文の、基本的な、構文を、理解し、テーブルに、1件の、レコードを、追加できる。
- [ ] カラム名を、指定する、方法と、省略する、方法の、違いと、推奨される、方法を、説明できる。
- [ ] 複数の、レコードを、一度に、挿入する、SQL文を、書くことができる。
- [ ] phpMyAdminの、GUIを、使って、データを、挿入し、その結果を、「表示」タブで、確認できる。
""
