...
| `13-3-2_1.svg` | `image/13-3-2_1.png` | 640×700 | ワイヤーフレームの実例（歯科医院の予約アプリ・連絡先入力画面） |
| `13-3-2_2.svg` | `image/13-3-2_2.png` | 760×520 | 🏃答え合わせ（9-4-9ブログシステム・投稿作成画面） |
| `13-3-4_1.svg` | `image/13-3-4_1.png` | 640×790 | 📖模範解答（カフェのモバイルオーダーアプリ・メニュー画面） |
| `13-8-2_1.svg` | `image/13-8-2_1.png` | 920×620 | 📖模範解答（経費精算アプリ・ユースケース図・アクター2） |
| `13-8-2_2.svg` | `image/13-8-2_2.png` | 640×700 | 📖模範解答（経費精算アプリ・申請作成画面のワイヤーフレーム） |
