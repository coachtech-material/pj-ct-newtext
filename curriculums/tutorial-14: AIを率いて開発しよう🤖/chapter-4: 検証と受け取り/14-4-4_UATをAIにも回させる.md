...
ここで足すのは Playwright MCP です。Playwrightはブラウザを自動で動かす道具で、それをMCPサーバの形にしたものが公式から配られています。足すと、AIは画面を開き、文字を入れ、ボタンを押し、スクリーンショットを撮れるようになります。自分で作る話はT15で扱うので、ここでは配られているものを1つ入れて使います。
