...
テストコードそのものは、あとでAIに書かせられます。そのとき人がやるのは、出てきたテストが決めた一覧を本当に埋めているかの突き合わせです。テストが全部緑になったことと、確かめたいことが確かめられたことは、別のことです。この受け取り方は14-4-1「検証をAIに渡す」で扱います。

いまは自分の手で書いてください。アサーションが何を見ているのかを掴んでいないと、AIが書いたテストを読んでも、それが十分かどうかを判定できません。
