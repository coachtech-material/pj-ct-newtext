...
Laravelは、認証機能を標準で提供しています。このTutorialのChapter 1で学んだ**Laravel Fortify**を使うと、以下の処理を自動的に行ってくれます。ここでは、内部でどのような処理が行われているかを理解するために、手動で認証を実装する場合のコード例を見てみましょう。
