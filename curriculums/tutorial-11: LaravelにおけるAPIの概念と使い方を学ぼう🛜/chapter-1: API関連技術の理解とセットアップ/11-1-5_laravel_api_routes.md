# Tutorial 11-1-5: LaravelでのAPI開発の準備
...
> 💡 **Tutorial 11-1-2で既に作成済みの場合**
>
> Tutorial 11-1-2で`Api/TaskController`を既に作成している場合は、このステップはスキップしてください。
...
> 💡 **Tutorial 11-1-2で既に作成済みの場合**
>
> Tutorial 11-1-2で作成した`TaskController`には、ダミーデータを返す実装がされています。
...
> 💡 **Tutorial 11-1-2で既に定義済みの場合**
>
> Tutorial 11-1-2で`Route::apiResource('tasks', TaskController::class)`を既に定義している場合は、このステップはスキップしてください。
