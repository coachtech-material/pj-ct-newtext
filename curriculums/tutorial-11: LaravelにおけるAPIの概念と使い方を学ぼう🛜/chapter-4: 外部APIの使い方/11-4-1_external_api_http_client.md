# Tutorial 11-4-1: 外部APIの利用（HTTP Client）

## 📖 このチャプターの進め方

このチャプターでは、Laravel HTTP Clientを使った外部API連携の方法を学びます。コード例が出てきますが、「外部APIとどのようにやり取りするか」を理解することが目的です。このチャプターにはハンズオンはありません。
...
これで、Tutorial 11「API開発基礎」の主要なセクションが完了しました。
