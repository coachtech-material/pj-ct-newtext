...
## 🎯 次のステップ：2つのTutorial 13

教材一覧には、名前の似たTutorial 13が2つ並んでいます。設計を学ぶ「tutorial-13: システム設計を学ぼう📐」と、以前の総仕上げ課題である「tutorial-13(旧): 総仕上げ！学んだ技術をフル活用してアプリケーションを作ってみよう🔥」です。どちらへ進むかは、この旧版に着手しているかどうかで決まります。

- **すでに旧版に着手している方**: そのまま旧版を最後まで進めて修了してください。進捗はそのまま残っています。修了後、余力があれば新しいTutorial 13〜16にも任意で取り組めます。
- **まだ着手していない方**: 「tutorial-13: システム設計を学ぼう📐」へ進んでください。旧版に取り組む必要はありません。Tutorial 13から16までが、これからの総仕上げにあたります。

判断に迷うときは、担当コーチに確認してください。
