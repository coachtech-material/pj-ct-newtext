# Tutorial 12-3-1: コードレビューの目的と効果

## 📖 このチャプターの進め方

このチャプターでは、コードレビューの目的、レビューする側・される側の心構え、レビューの練習について学びます。コード例やレビューコメントの例が出てきますが、まずは「良いレビューとは何か」を理解しながら読み進めてください。一部のセクションには思考演習もあります。チャプターの最後にあるハンズオン（12-3-5）で、実際にレビューを実践します。
