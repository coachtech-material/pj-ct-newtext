...
<img alt="7-2-6_1.png" src="https://s3.ap-northeast-1.amazonaws.com/coachtech-lms-bucket-dev/curriculums/images/7-2-6_1.png">
...
- `practice/` ディレクトリ内のファイル（`grade_calculator.php` など）を **publicリポジトリ** で管理する
- リポジトリ名は **`php-control-practice`** とする
...
```bash
# practice ディレクトリに移動
cd ~/php-practice/src/7-2-6_hands-on/practice
...
- [ ] GitHub に `php-control-practice` リポジトリを作成した（**public** で作成）
- [ ] 要件5の雛形を参考に `README.md` を **自分の言葉で** 作成した
