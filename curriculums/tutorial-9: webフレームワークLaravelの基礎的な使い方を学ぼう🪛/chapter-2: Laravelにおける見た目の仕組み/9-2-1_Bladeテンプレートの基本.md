# 9-2-1: Bladeテンプレートの基本（データの表示）

## 📖 このチャプターの進め方

このチャプターでは、Bladeテンプレートの書き方や構文を学びます。コード例が多く出てきますが、まずは「Bladeではこう書くんだな」と理解しながら読み進めてください。実際にBladeファイルを作成して動かすのは、チャプターの最後にあるハンズオン（9-2-5）で行います。
