...
データベースを、運用していく中で、不要になった、データを、削除する、必要が、出てきます。例えば、退会した、ユーザーの、情報や、古くなった、お知らせ記事などです。このような、レコードを、テーブルから、取り除くために、使われるのが、DML（データ操作言語）の、**`DELETE`** 文です。
