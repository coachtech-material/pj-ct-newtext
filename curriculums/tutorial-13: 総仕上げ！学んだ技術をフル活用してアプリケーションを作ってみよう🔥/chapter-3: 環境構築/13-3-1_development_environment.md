...
要件定義、データベース設計、その他設計が終わったら、いよいよ**開発できる状態**を作ります。
...
| `task-manager-app` | プロジェクト名（ディレクトリ名） |

---

## Step 3: Laravel Sailのインストール

プロジェクト作成後、`task-manager-app`ディレクトリに移動し、Laravel Sailをインストールします。
